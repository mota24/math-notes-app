/** Les pictogrammes de la bibliothèque : traits fins et arrondis, à la taille et à la couleur du texte qui les entoure. */
const PATHS = {
  library: (
    <>
      <path d="m16 6 4 14" />
  ...
  star: <path d="m12 2.5 3.1 6.3 6.9 1-5 4.9 1.2 6.9-6.2-3.3-6.2 3.3L7 14.7 2 9.8l6.9-1z" />,
  ellipsis: (
    <>
  ...
  pen: (
    <>
      <path d="M12 20h9" />
      <path d="M16.4 3.6a1 1 0 0 1 3 3L7.4 18.6a2 2 0 0 1-.9.5l-2.9.8a.5.5 0 0 1-.6-.6l.8-2.9a2 2 0 0 1 .5-.9z" />
    </>
  ),
  settings: (
    <>
